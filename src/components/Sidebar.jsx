...
import { LayoutDashboard, Users, CalendarDays, Car, CreditCard, Headphones as HeadphonesIcon, UserCog, Settings as SettingsIcon, LogOut, X, History, Wrench, KeyRound, MapPin, UserCheck, Crown, ClipboardList } from 'lucide-react';
...
const ALL_MENU_ITEMS = [
  ...
  { id: 'surveys',      label: 'Sondages',         icon: ClipboardList,   path: '/surveys' },
